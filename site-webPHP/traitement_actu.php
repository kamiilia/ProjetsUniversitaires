...
mysql_query("set names 'utf8'");/*mettre les noms en utf8*/
...
if($row_actu_aside==null){//cas ou il n'y pas d'actu
	echo "Pas d'actualités cette semaine";}
	else{//cas ou il y'a des actu
